  ...
  return (
    <>
      ...
      <div className="mx-auto container flex xl:justify-between justify-center items-center xl:mt-14 md:mt-[48px] mt-[35px] xl:px-6 lg:px-3 md:px-0 px-[4px] overflow-hidden">
        <div className="xl:mt-0 md:-mt-28 -mt-24" ><img src="./images/Group 5482.svg" className="xl:w-[187.6px] xl:h-[360.53px] lg:w-[187.6px] lg:h-[360.53px] w-[82.96px] h-[188.98px] " alt="" /></div>

        <div className="xl:w-[624px] lg:w-[571px] md:w-[533.27px] w-full relative">
          <div className="flex items-center justify-between relative z-20">
            <div className="bg-neutral-900 flex flex-col items-center justify-center xl:w-[107.55px] xl:h-[107.55px] lg:w-[98.41px] lg:h-[98.41px] md:w-[91.91px] md:h-[91.91px] w-[44.28px] h-[44.28px] rounded-full">
            ...
            <div className="bg-neutral-900 flex flex-col items-center justify-center xl:w-[107.55px] xl:h-[107.55px] lg:w-[98.41px] lg:h-[98.41px] md:w-[91.91px] md:h-[91.91px] w-[44.28px] h-[44.28px] rounded-full">
              <img src="./images/notion.svg" alt="" className="xl:w-[44.81px] xl:h-[44.81px] lg:w-[41.01px] lg:h-[41.01px] md:w-[38.3px] md:h-[38.3px] w-[18.45px] h-[18.45px]" />
            </div>
          </div>
          ...
          <div className="flex items-center justify-center mt-10 relative z-20">
            <div className="bg-neutral-900 flex flex-col items-center justify-center xl:w-[107.55px] xl:h-[107.55px] lg:w-[98.41px] lg:h-[98.41px] md:w-[91.91px] md:h-[91.91px] w-[44.28px] h-[44.28px] rounded-full">
              <img src="./images/GroupCard.svg" alt="" className="xl:w-[44.81px] xl:h-[44.81px] lg:w-[41.01px] lg:h-[41.01px] md:w-[38.3px] md:h-[38.3px] w-[18.45px] h-[18.45px]" />
            </div>
          </div>

          <img className={`absolute z-0 w-full inset-0 lg:-mt-[1.5rem] md:mt-[-42px] -mt-[0.5rem]`} src="./images/Vector.svg" alt="background" />
          ...
          <div className="absolute  inset-0 lg:px-[120px] md:px-[70px] px-[60px] flex flex-col items-center justify-center lg:-mt-12 md:-mt-8 -mt-10">
            ...
            <div className="absolute lg:-mt-14 md:-mt-16 -mt-6">
              <div className="xl:w-[177px] xl:h-[177px] lg:w-[162px] lg:h-[162px] md:w-[151px] md:h-[151px] w-[73px] h-[73px] rounded-full border-[3.36086px] border-neutral-900 flex flex-col items-center justify-center md:p-3.5 p-1">
                <div className="w-full h-full rounded-full flex flex-col items-center justify-center bg-neutral-900">
                  <img className="xl:w-[58.23px] lg:w-[53.28px] md:w-[49.76px] w-[23.98px]" alt="" src="./images/wove.svg" />
                </div>
              </div>
            </div>
            <div className="flex items-center justify-between w-full lg:mt-[130px] md:mt-[101.48px] mt-[36.89px]">
        ...
        <div className="xl:mt-0 md:-mt-28 -mt-24" ><img src="./images/Group 5483.svg" className="xl:w-[187.6px] xl:h-[360.53px] lg:w-[187.6px] lg:h-[360.53px] w-[82.96px] h-[188.98px]" alt="discord" /></div>
      </div>
    </>
  )
}
